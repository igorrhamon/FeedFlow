...
mixin _$Queue {
  ...
  String get icon =>
      throw _privateConstructorUsedError; // nome do ícone Material (ex: 'inbox', 'star') — string simples
  int get order => throw _privateConstructorUsedError;
  QuerySpec get querySpec => throw _privateConstructorUsedError;
...
abstract class $QueueCopyWith<$Res> {
  ...
  $QuerySpecCopyWith<$Res> get querySpec;
}
...
class _$QueueCopyWithImpl<$Res, $Val extends Queue>
    ...
    return _then(
      _value.copyWith(
            ...
            querySpec:
                null == querySpec
                    ? _value.querySpec
                    : querySpec // ignore: cast_nullable_to_non_nullable
                        as QuerySpec,
          )
          as $Val,
    );
  ...
  @pragma('vm:prefer-inline')
  $QuerySpecCopyWith<$Res> get querySpec {
    return $QuerySpecCopyWith<$Res>(_value.querySpec, (value) {
      return _then(_value.copyWith(querySpec: value) as $Val);
    });
  }
}
...
class _$QueueImpl implements _Queue {
  ...
  @override
  final String icon;
  // nome do ícone Material (ex: 'inbox', 'star') — string simples
  @override
  final int order;
  @override
  ...
  @override
  String toString() {
    return 'Queue(id: $id, name: $name, icon: $icon, order: $order, querySpec: $querySpec)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.querySpec, querySpec) ||
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, icon, order, querySpec);
...
abstract class _Queue implements Queue {
  const factory _Queue({
    ...
    required final QuerySpec querySpec,
  }) = _$QueueImpl;
  ...
  String get name;
  @override
  String get icon; // nome do ícone Material (ex: 'inbox', 'star') — string simples
  @override
  int get order;
  @override
  QuerySpec get querySpec;
